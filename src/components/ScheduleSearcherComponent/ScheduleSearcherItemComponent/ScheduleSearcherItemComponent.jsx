...
import './ScheduleSearcherItemComponent.css'; // Importa tu archivo de CSS

function ScheduleSearcherItemComponent({ schedule }) {
  return (
...
export default ScheduleSearcherItemComponent;
