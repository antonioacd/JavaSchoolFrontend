...
import ScheduleSearcherItem from './ScheduleSearcherItemComponent/ScheduleSearcherItemComponent';
import ScheduleService from '../../services/ScheduleService';
import AutocompleteComponent from '../AutocompleteComponent/AutocompleteComponent';
import './ScheduleSearcherComponent.css';

class ScheduleSearcher extends Component {
  constructor(props) {
    super(props);
...
export default ScheduleSearcher;
